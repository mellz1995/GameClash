//
//  MainMenuToTicTacToeAnimator.swift
//  Game Clash
//
...
class MainMenuToTicTacToeAnimator: NSObject, UIViewControllerAnimatedTransitioning, UIViewControllerTransitioningDelegate {
